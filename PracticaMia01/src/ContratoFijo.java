public class ContratoFijo extends empleado{
    public ContratoFijo(int carnet, String nombre, String apellipo, double fechaIngreso, int sueldoMensual, int promCumplimProyectos, int numProyParticipa) {
